    ...
    >
      ...
      <AnimatePresence mode="wait">
        {toggleName ? (
          ...
          >
            <h1 className="text-center font-mono font-bold text-6xl tracking-wider italic">
              MengXun
            </h1>
            <h1 className="ml-2 font-montserrat font-extrabold text-6xl tracking-wider primary-gradient-text">
              Liu
            </h1>
          </motion.div>
        ) : (
