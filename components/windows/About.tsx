        ...
        <DragWindow title="About." id="about" className="sm:min-w-2xl">
            ...
            <div className="text-start mt-2 flex max-h-81.25 overflow-y-auto justify-start w-full flex-col gap-4 p-5">
                ...
                <p className="mt-2 ml-4 list-disc list-inside text-start space-y-1">
                    ...
                    <br />
                    • <span className="text-bright-amber font-bold">Python</span> Enjoyer.
                    <br />
                    • Watching brainrot shit posts everyday.
                    <br />
                    • Grade Cooker. I dont want to study bro🥀🥀
                    <br />
                    • ACT Lover, especially Silksong, ZZZ, Monster Hunter.
                </p>
                ...
                <h1 className="mt-3 text-3xl">
                    <label className="text-sm font-normal text-ink-700 mr-3">(get in)</label>TOUCH ME???
                </h1>
                <div className="flex flex-col gap-4">
                    <p>
                        Feel free to say hi to me!<br />
                        I keep it lowkey bruh.<br />
                        I need some homies now.😭😭😭
                    </p>
                    <p>
                ...
                <div className="p-4 bg-black/20 rounded-xl border border-white/5 font-mono text-sm flex flex-col gap-1 shadow-inner">
                ...
                {/* HACK: Minion Image */}
                <div className="py-2">
                    <Image src="/img/minion.png" alt="Minion" width={100} height={100} priority={true} className="object-contain" />
                </div>
                ...
                <div className="mt-4 flex flex-col gap-2 text-lg">
                    ...
                    <p className="text-ink-700 leading-relaxed opacity-70 ">
                        (I knew there're a lot of AI slot in src, i'll rewrite it later.<br /> 
                        Dont judge me.😭😭😭<br />
